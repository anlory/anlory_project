 ...
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_com_example_anlory_uart_Uart_closeDev
...
static JNINativeMethod meMethods[] = {
	{"readBuf","(I)Ljava/lang/String;",(void *)Java_com_example_anlory_uart_Uart_readBuf},
	{"writeBuf","(ILjava/lang/String;I)I",(void *)Java_com_example_anlory_uart_Uart_writeBuf},
	{"closeDev","()I",(void *)Java_com_example_anlory_uart_Uart_closeDev},
	{"openDev","(I)I",(void *)Java_com_example_anlory_uart_Uart_openDev},
};
...
JNI_OnLoad(JavaVM *jvm, void *reserved)
{
	...
	cls = (*env)->FindClass(env, "com/example/anlory/uart/Uart");
	if (cls == NULL) {
